...
from .views import BudgetStatusView,BudgetDetails,BudgetView,ExpensesView,CategoryView,ExpenseDetailView,CategoryDetailView,RecurringExpenseView,RecurringExpensesDetailView
...
urlpatterns = [
    ...
    path('budget_details/<uuid:uuid>/',BudgetDetails.as_view(),name='budget_details'),
